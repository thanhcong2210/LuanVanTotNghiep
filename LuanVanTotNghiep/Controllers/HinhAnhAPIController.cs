...
namespace LuanVanTotNghiep.Controllers
{
    public class HinhAnhAPIController : ApiController
    {
        ...
        public HttpResponseMessage Post(HINHANH ha)
        {
            ...
            {
                var list = db.sp_InsUpdDelHinhAnh(0, ha.DUONGDAN1, ha.DUONGDAN2, ha.DUONGDAN3 , "Ins").ToList();
        ...
        public HttpResponseMessage Put(HINHANH ha)
        {
            ...
            try
            {
                list = db.sp_InsUpdDelHinhAnh(ha.MAHINHANH, ha.DUONGDAN1, ha.DUONGDAN2, ha.DUONGDAN3, "Upd").ToList();
            }
