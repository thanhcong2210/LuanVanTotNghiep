...
namespace LuanVanTotNghiep.Api
{
    public class NhaHangAPIController : ApiController
    {
        ...
        public HttpResponseMessage Post(NHAHANG t)
        {
            ...
            {
                var list = db.sp_InsUpdDelNhaHang(0, t.TENNHAHANG,t.SDT,t.FAX, t.DIACHI, t.GIOITHIEU, "Ins").ToList();
        ...
        public HttpResponseMessage Put(NHAHANG t)
        {
            ...
            try
            {
                list = db.sp_InsUpdDelNhaHang(t.MANHAHANG, t.TENNHAHANG, t.SDT, t.FAX, t.DIACHI, t.GIOITHIEU, "Upd").ToList();
            }
